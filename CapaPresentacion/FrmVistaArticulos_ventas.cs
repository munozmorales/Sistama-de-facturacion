...
{
    public partial class FrmVistaArticulos_ventas : Form
    {
        public FrmVistaArticulos_ventas()
        {
            InitializeComponent();
        }
        ...
        private void FrmVistaArticulos_ventas_Load(object sender, EventArgs e)
        {
        ...
        private void dataListado_DoubleClick(object sender, EventArgs e)
        {
            ...
            int par5;
            DateTime par6;
            par1 = Convert.ToString(this.dataListado.CurrentRow.Cells["iddestalle_ingreso"].Value);
